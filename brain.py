...
#
#  v3: Veto Haiku retorna confidence score para conviction funcional
# =============================================================
...
El sistema ya validó una entrada técnica mecánicamente. Tu trabajo tiene dos partes:
...
PARTE 2 — CONFIDENCE SCORE (1-10):
Independientemente del veto, evaluá la calidad del setup y asigná un score:
- 10: setup perfecto — todos los indicadores alineados, régimen fuerte, volumen alto
- 8-9: setup sólido — la mayoría de indicadores a favor, sin señales de alarma
- 6-7: setup aceptable — algunos indicadores mixtos pero tendencia clara
- 4-5: setup débil — indicadores contradictorios o régimen joven
- 1-3: setup pobre — múltiples señales de alarma
 
Respondé ÚNICAMENTE con JSON válido, sin texto adicional:
{"veto": false, "reason": "", "confidence": 8}
{"veto": true, "reason": "razón concreta en 1 línea", "confidence": 3}"""
...
def analyze_veto(symbol: str, direction: str, conditions: dict,
    ...
    v3: ahora retorna confidence score 1-10 que modula la conviction real.
    Retorna: {veto: bool, reason: str, confidence: int, tokens: int}
    """
    ...
    try:
        ...
        # Si no parsea el JSON, aprobamos con confidence media
        return {"veto": False, "reason": "parse error — señal aprobada por default",
                "confidence": 7, "tokens": 0}
    except Exception as e:
        return {"veto": False, "reason": f"error Claude: {e}",
                "confidence": 7, "tokens": 0}
